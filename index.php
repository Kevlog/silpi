...
<html lang="en">
    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        ...
        <div class="container">
            ...
            <h1 class="text-center mb-4 mt-4 pb-4 pt-4 text-light" data-aos="zoom-in">Sistem Informasi <i>Log Book</i> Praktik Industri</h1>
            <div class="row mt-4">
                ...
                <div class="col-md-4 col-sm-4" data-aos="fade-left">
                    <a href="file.php" class="btn btn-outline-info text-light" tabindex="-1" role="button" aria-disabled="true"><i class="bi bi-file-earmark-arrow-up"></i>&nbsp;&nbsp;Unggah Dokumen</a>
                </div>
                <div class="col text-end" data-aos="fade-left">
                    <a href="tambah.php" class="btn btn-outline-success text-light" tabindex="-1" role="button" aria-disabled="true"><i class="bi bi-person-plus"></i>&nbsp;&nbsp;Tambah Data</a>
                </div>
            </div>
            <br>
            <div class="table-responsive">
                <table class="table bg-secondary table-bordered table-hover text-light text-center" border="1" cellpadding="10" cellspacing="0" data-aos="zoom-in" data-aos-duration="1000">
                    <thead>
                        <tr class="bg-dark text-light d-flex text-center">
                            <th class="col-1">Pertemuan</th>
                            <th class="col-1">Tgl</th>
                            <th class="col-1">Pukul</th>
                            <th class="col-1">Judul Kegiatan</th>
                            <th class="col-6">Sub Bahasan</th>
                    ...
                    <tbody>
                        ...
                        <tr class="d-flex">
                            <td class="col-1"><?= $i; ?></td>
                            <td class="col-1"><?= $row["tanggal"]; ?></td>
                            <td class="col-1"><?= $row["pukul"]; ?></td>
                            <td class="col-1"><?= $row["judul"]; ?></td>
                            <td class="col-6 text-justify" size="50"><?= $row["sub"]; ?></td>
                            <td class="col-1"><img src="img/<?= $row ["gambar"]; ?>" width="50" alt=""></td>
                            <td class="col-1">
                                <a href="ubah.php?id=<?= $row["id"]; ?>" class="btn btn-outline-warning" title="Ubah Data"><i class="bi bi-pencil-square"></i></a>
                                <a href="hapus.php?id=<?= $row["id"]; ?>" id="hapus" onclick= "return confirm('Apakah yakin ingin menghapus data, <?= $row["judul"];?>?');" class="btn btn-outline-danger" title="Hapus Data"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php $i++; ?>
