...
<html lang="en">
    ...
    <meta charset="UTF-8">
        ...
        <title>Halaman Admin - SILPI</title>        
        <!-- Bootstrap -->
    ...
    <body class="bg-custom" style="background-image: url('assets/img/unesa.jpg');">
        <div class="container">
            ...
            <div class="row mt-4">
                ...
                <!-- <div class="col text-end" data-aos="fade-left">
                    <a href="tambahuser.php" class="btn btn-outline-success text-light" tabindex="-1" role="button" aria-disabled="true"><i class="bi bi-person-plus"></i>&nbsp;&nbsp;Tambah User</a>
                </div> -->
            </div>
            <br>
                ...
                <table class="table bg-secondary table-bordered table-hover text-light text-center" border="1" cellpadding="10" cellspacing="0" data-aos="zoom-in" data-aos-duration="1000">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?= $row["level"]; ?></td>
                            <td>
                                <a href="ubahprofileadmin.php?id=<?= $row["id"]; ?>" class="btn btn-outline-warning" title="Ubah Data"><i class="bi bi-pencil-square"></i></a>
                                <a href="hapusprofile.php?id=<?= $row["id"]; ?>" id="hapus" onclick= "return confirm('Apakah yakin ingin menghapus data ?');" class="btn btn-outline-danger" title="Hapus Data"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php $i++; ?>
